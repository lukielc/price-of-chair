    ...
    def send(self):
        return requests.post(
            ...
            data={
                ...
                "to": self.user_email,
                "subject": "Price limited reached for {}".format(self.item.name),
                "text": "We've found a deal ({}). To navigate to the alert, please visit {}".format(self.item.url, "http://pricing.abc.com/alerts/{}".format(self._id))
            }
        )
